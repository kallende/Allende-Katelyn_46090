 ...
 * Purpose: Homework, Given date output the day of the week. 
 */
 ...
 * Input: 
 *      month -> Months associated with AD
 *      year  -> Years associated with AD    
 * Output:
 *      int   -> Number dependent upon month 
 ************************************************************************
 ************************************************************************/
 ...
 *      year   -> Year associated with AD     
 * Output:
 *      string -> numDay, Day of the week 
 ************************************************************************
 ************************************************************************/
...
**************************atoiLk*****************************************
*************************************************************************
 * Purpose: To determine day. 
 * Input: 
 *      day     -> Day in the month   
 * Output:
 *      number  -> rday, Day in the month 
 ************************************************************************
 ************************************************************************/
int atoiLk (char n[]){
   //Declare Variable
